...
3. **デプロイ**
   ...
   - 詳細手順: [デプロイガイド](./DEPLOYMENT.md)

4. **品質保証**
   - 詳細手順: [E2Eテストガイド](./E2E_TESTING.md)

5. **ドキュメント管理**
   - コードの変更に合わせて、関連ドキュメント（`README.md`, `docs/`, `RULEBOOK.md`等）を更新する
   - "Docs as Code" の原則に従い、ドキュメントの鮮度と正確性を維持する責任を持つ
   - 特に仕様変更や機能追加時は、ドキュメント更新を完了条件の一部とする
